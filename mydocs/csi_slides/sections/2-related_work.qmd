...
::: {#tbl-medpathway style="font-size: 0.45em;"}
...
| BEHRT (@liBEHRTTransformerElectronic2020) | BERT | MLM | Disease prediction| not reported (~6L, 12H, h=288) | 1.6M patients | 301 disease codes | ❌ | ❌ |
...
- @wagerCausalInferenceStatistical: reading group

## Causal impact of PCP loss on health outcomes - WIP  {.unnumbered}