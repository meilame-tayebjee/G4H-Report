## Transformer-based models for medical pathway embedding {.unnumbered .scrollable}
...
|-|------|-------|-------|----|---|-----|-|-
| coMET (@coMET) | GPT | Next token pred. | Disease prediction | 1B | 151B events from 118M patients | 7,105 (exhaustive) | ✅ | ✅ |
